fixio - FIX Protocol Support for Netty [![Build Status](https://travis-ci.org/kpavlov/fixio.png?branch=java6)](https://travis-ci.org/kpavlov/fixio.svg?branch=java6)
=====
